...
/**
 * An implementation of the query service using Mybatis. The service
 * accomplishes search by
 * first looking up a query name in a query store. It retrieves the metadata
 * about the query
 * that includes a Mybatis query name. This is used to execute the query using
 * Mybatis.
...
public class NamedQueryServiceSpringMybatisImpl extends AbstractSearchServiceImpl {
	...
	protected SearchResponse doSearch(EnhancedSearchRequest searchRequest, SearchResponse searchResponse,
	...
	protected int processCountQuery(Map<String, Object> filters, SearchResponse searchResponse,
			QueryMetadata queryMetadata) {
